XXXXXXXXXXXXXXX
<section class="dossiers" data-rid="{{id}}" data-town="{{town}}" data-address="{{address}}" data-area_name="{{area_name}}" data-name="{{name}}">
    <div class="well">
            ...
            <?php 
                    ...
                    elseif( $dossiers_cat['speciality'] ) { //default image for speciality
                        switch ( $dossiers_cat['speciality'] ) 
                        {
            ...
            <div class="col-sm-4">
                    ...
                    <h4>{{name}}
                        <!--<a href="dossiers/dossiers/{{id}}">{{name}}</a>-->
                    </h4>
                    <h5><?php 
                            if($dossiers_cat['speciality']) echo $dossiers_cat['speciality'];
                            if($dossiers_cat['speciality'] and $groupe['subset']) echo " &bullet; ";
        ...
        <span class="clearfix"></span>
            ...
            <div class="weekcalendar ">
                ...
                <center class="h4">
                    ...
                    <a class="btn btn-default next-week" href="{{ url:site }}dossiers/view/{{id}}/{{ cal_week:next_week_no }}"> 
...
<!--                <p>
        ...
        {{ if user:has_cp_permissions }} 
                <a target="_blank" class="adminlink" href="<?php echo site_url() ?>admin/dossiers/edit/{{id}}">Modifier</a>
        {{endif}}
</section>
