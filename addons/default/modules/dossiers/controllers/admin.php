    ...
    public function index()
    {
        ...
        $extra['buttons'] = array(
            array(
                ...
                'url' => 'admin/dossiers/edit/-entry_id-'
            ),
            array(
                'label' => lang('global:delete'),
                'url' => 'admin/dossiers/delete/-entry_id-',
                'confirm' => true
            )
        );
...
//                    ->build('admin/form' );
    ...
    {
        $this->streams->entries->delete_entry($id, 'dossiers', 'dossiers');
